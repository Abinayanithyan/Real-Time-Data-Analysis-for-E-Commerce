...
def run_streaming(producer: KafkaProducer, topic: str, interval: float, count: int) -> None:
    ...
    for _ in range(count):
        ...
        try:
            ...
            print(f"✅ Sent: {transaction['transaction_id']} | {transaction['product_name']} | ${transaction['price']}")
...
if __name__ == "__main__":
    ...
    # FIXED: Use localhost when running from host, kafka when running in container
    producer = create_kafka_producer(bootstrap_servers=["localhost:9092"])
